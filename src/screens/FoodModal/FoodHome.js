      ...
      <div className="foodInnerModal">
        <div className="foodCard">
          <div className="foodHalfCard">
            ...
            <h0 className="foodModalSubTitle">
              Descriere despre bucataria locala. Lorem ipsum dolor sit amet,
              consectetur adipiscing elit. Proin sit amet dignissim leo.
            </h0>
            <Link
        ...
        <div className="foodCard">
          <div className="foodHalfCard">
            ...
            <Link
              ...
              to="/food/event-hall"
            >
              <button className="foodModalDetailButton">
                <a href="/food">Galerie foto</a>
              </button>
            </Link>
          </div>
        </div>
