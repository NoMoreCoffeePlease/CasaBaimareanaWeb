...
function BookingStage2({
  ...
  const handleMethod = (option) => {
    switch (option) {
      case "cash":
        setState((prevState) => ({ ...prevState, paymentMethodCash: true }));
        break;
      case "card":
        setState((prevState) => ({ ...prevState, paymentMethodCash: false }));
        break;
      default:
        return null;
    }
  ...
  const formValid = () => {
    ...
    if (state.paymentMethodCash === null) return "Alege metoda de plată";
  ...
  const onSubmitPress = () => {
    firebase.db
      ...
      .add({
        ...
        checkIn: state.startDate.toString("dddd, MMMM, yyyy"),
        checkOut: state.endDate.toString("dddd, MMMM, yyyy"),
        simpleValue: state.simpleValue,
        doubleValue: state.doubleValue,
        tripleValue: state.tripleValue,
    ...
    <div className="componentContainer">
      <div className="subTitle">
        <p className="subTitleText">
          Completeaza datele personale si alege modalitatea de plata pentru
      ...
      <div className="formContainer">
        <div className="formStyle">
          ...
          <br></br>
          <label className="formStatements">
            <input
              type="checkbox"
              id="privacyCheck"
              checked={state.terms}
