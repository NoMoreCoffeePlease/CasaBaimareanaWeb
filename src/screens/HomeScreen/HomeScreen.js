...
const TEXTS = ["Baimareana", "ta de vacanta"];
  ...
  return (
    <div
      ...
      onScroll={() => {
        ...
        if (top.scrollTop > 500) scrollButton.style.display = "flex";
        else {
    ...
    >
      <div className="datePickerContainer" id="top">
        ...
        <div className="roomDetailContainer">
          ...
          <div className="detailElement">
            <img
              src="https://picsum.photos/702/300"
              alt=""
              className="imageDetail"
            ></img>
      ...
      <div className="presentationFrame">
        <div id="aboutUs" className="presentationTitle">
          CINE SUNTEM NOI?
        </div>
        <div className="presentationSubTitle">
          Descriere despre voi, misiune, obiectiv, text atractiv.
        </div>
        ...
        <div className="presentationSubTitle">
          Descriere despre facilitati, despre tot ceea ce gasiti wow la voi.
        </div>
        <div className="test">
          <button
        ...
        <div className="reviewsContainer">
          <div className="reviewLeft">
            "A pleasant surprise. Great conditions for a low price. Nice room,
            very friendly hosts, good breakfast. " {<br></br>}
            <span className="reviewsAuthor"> - Alex</span>
          </div>
      ...
      <div className="presPicture">
        <div className="bmContainer">
          <span className="bmStyle">BAIA MARE</span>
        </div>
        <div className="test">
          <button
      ...
      <div className="presPicture">
        <div className="presCaptionContainer">
          <span className="bmStyle">VA ASTEPTAM LA NOI!</span>
        </div>
      </div>
        ...
        <div className="homeFooterContainer">
          <div className="menuFooterContainer">
            <ul className="home-listResetStyle">
              ...
              <br></br>
              <li
                className="menuFooter-item center-item"
                onClick={() => history.push("/BookingStage00")}
              >
                Rezervă acum
              </li>
              <li
          ...
          <div className="contactFooterContainer">
            ...
            <span className="contactFooter-address">
              str. Vasile Alecsandri, nr. 39, Baia Mare 430306, Maramureș,
              România
            </span>
            ...
            <div className="contactFooter-iconContainer">
              <img
                src={require("../../svg/mail-black.svg")}
                alt=""
                className="contactFooter-emailIcon"
              ...
              >
                <img
                  ...
                  alt=""
                  className="contactFooter-fbIcon"
      ...
      <StyleRoot>
        ...
        >
          <img
            src={require("../../svg/arrowBack-black.svg")}
            alt=""
