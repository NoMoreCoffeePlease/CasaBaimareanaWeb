  ...
  return (
    <StyleRoot>
      ...
      >
        <div className="row">
          <img
            src={require("../../svg/right-arrow.svg")}
            className="pinArrow"
          />
          <div
            className="pinHeader"
        ...
        >
          <img
            src={require("../../svg/place-black.svg")}
            className="locationIcon"
          />
          <span className="pinBodyText">
            str. Vasile Alecsandri, nr. 39, Baia Mare 430306, Maramures{" "}
            <br></br>+40-7xx-xxx-xxx
          </span>
        </div>
        <div
          className="pinFooter"
...
const LocationPin = () => {
  ...
  return (
    <div className="pinMainContainer">
      <div
