  ...
  const [state, setState] = useState({
    ...
    startDate:
      startDate === null || startDate === undefined
        ...
        : new Date(startDate),
    endDate:
      endDate === null || endDate === undefined ? undefined : new Date(endDate),
          ...
          <DateRangeInput
            ...
            monthLabelFormat={(selectedDate) => {
              switch (selectedDate.getMonth()) {
                case 1:
                  return `Februarie ${selectedDate.getFullYear()}`;
                case 2:
                  return `Martie ${selectedDate.getFullYear()}`;
                case 3:
                  return `Aprilie ${selectedDate.getFullYear()}`;
                case 4:
                  return `Mai ${selectedDate.getFullYear()}`;
                case 5:
                  return `Iunie ${selectedDate.getFullYear()}`;
                case 6:
                  return `Iulie ${selectedDate.getFullYear()}`;
                case 7:
                  return `August ${selectedDate.getFullYear()}`;
                case 8:
                  return `Septembrie ${selectedDate.getFullYear()}`;
                case 9:
                  return `Octombrie ${selectedDate.getFullYear()}`;
                case 10:
                  return `Noiembrie ${selectedDate.getFullYear()}`;
                case 11:
                  return `Decembrie ${selectedDate.getFullYear()}`;
                case 0:
                  return `Ianuarie ${selectedDate.getFullYear()}`;
                default:
                  return;
              }
            }}
        ...
        <div className="inputPeople">
          <div className="inputContainer">
            <div className="inputLabel">
              <img src={require("../../svg/people_outline.svg")} alt="" />
            </div>
            <input
              id="adults"
              placeholder="Adulti"
          ...
          <div className="inputContainer">
            <div className="inputLabel">
              <img src={require("../../svg/person_outline.svg")} alt="" />
            </div>
            <input
              id="children"
              placeholder="Copii"
...
const mapDispatchtoProps = (dispatch) => ({
  addData: (startDate, endDate, adults, children) =>
    dispatch({
